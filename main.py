...
# ----------------------------------------------------------
st.set_page_config(
    page_title="EcoTorque - Smart EV Innovation Analyzer",
    layout="wide",
    page_icon="⚡",
...
# ----------------------------------------------------------
if page == "🏠 Home":
    st.markdown("<div class='big-title'>Welcome to EcoTorque ⚡</div>", unsafe_allow_html=True)
...
# ----------------------------------------------------------
    ...
    st.markdown("<div class='big-title'>EcoTorque AI Assistant 🧠</div>", unsafe_allow_html=True)
    ...
    if "conversation" not in st.session_state:
        system_prompt = """You are EcoTorque AI, an expert electric vehicle analyst. You help users understand 
    ...
    if st.button("Send 💥") and user_input.strip() != "":
        ...
        try:
            with st.spinner("⚡ EcoTorque is analyzing..."):
    ...
    for i, message in enumerate(st.session_state.conversation):
        ...
        if message["role"] == "user":
            ...
            st.markdown(f"<div class='chat-box bot'>⚡ <b>EcoTorque:</b> {message['parts'][0]}</div>", unsafe_allow_html=True)
...
# ----------------------------------------------------------
    ...
    if st.button("🔍 Analyze Innovation Score"):
        if model_name.strip():
            query = f"Analyze the {brand} {model_name} using the EcoTorque Innovation Score methodology. Provide scores for Technology (40%), Efficiency (30%), and User Value (30%), along with a final composite score out of 100."
...
# ----------------------------------------------------------
    ...
    st.markdown("<div class='big-title'>About EcoTorque 🌟</div>", unsafe_allow_html=True)
    st.markdown("""
    EcoTorque was created to bring **objective, data-driven analysis** to the electric vehicle market.  
    ...
    **Our Solution:**  
    ...
    st.info("""
    **EcoTorque aims to democratize EV knowledge with price and range comparison** by making sophisticated analysis accessible to everyone.
    ...
    st.markdown("### 👨‍💻 Creator")
    st.success("""
    Developed by **Stuti Shukla**, passionate about sustainable transportation and AI innovation.  
